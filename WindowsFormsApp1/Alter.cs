    ...
    public partial class Alter : Form
    {
                ...
                case (3):
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(conn))
                        {
                            ...
                            SqlDataAdapter countadap = new SqlDataAdapter(countCmd);
                            countadap.Fill(counttab);
                            comboBox4.DataSource = counttab;
                            comboBox4.DisplayMember = "country_name";
                            comboBox4.ValueMember = "country_id";
                        }
                        break;
                    }
                case (4):
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(conn))
                        {
                            ...
                            SqlDataAdapter countadap = new SqlDataAdapter(countCmd);
                            countadap.Fill(counttab);
                            comboBox9.DataSource = counttab;
                            comboBox9.DisplayMember = "country_name";
                            comboBox9.ValueMember = "country_id";
                        }
                        break;
                    }
                case (5):
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(conn))
                        {
                            ...
                            SqlDataAdapter langadap = new SqlDataAdapter(langCmd);
                            langadap.Fill(langtab);
                            comboBox11.DataSource = langtab;
                            comboBox11.DisplayMember = "language_name";
                            comboBox11.ValueMember = "language_id";
                            ...
                            SqlDataAdapter typeadap = new SqlDataAdapter(typeCmd);
                            typeadap.Fill(typetab);
                            comboBox10.DataSource = typetab;
                            comboBox10.DisplayMember = "type_name";
                            comboBox10.ValueMember = "type_id";
                            ...
                            comp.Expression = "[publname]+', '+[countname]";
                            publtab.Columns.Add(comp);
                            comboBox12.DataSource = publtab;
                            comboBox12.DisplayMember = "col1";
                            comboBox12.ValueMember = "publid";
                        }
                        break;
                    }
                case (6):
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(conn))
                        {
                            ...
                            comp.Expression = "[type]+': '+[name] +'. Язык: '+[lang]+'. Год выпуска: '+[year]";
                            publtab.Columns.Add(comp);
                            comboBox14.DataSource = publtab;
                            comboBox14.DisplayMember = "col1";
                            comboBox14.ValueMember = "publid";
                            ...
                            comboBox13.DataSource = authtab;
                            comboBox13.DisplayMember = "col1";
                            comboBox13.ValueMember = "author_id";
                        }
                        break;
                    }
            }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("countries_update", connection);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("languages_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("publtype_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("authors_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    ...
                    sqlCmd.Parameters.AddWithValue("@country", comboBox8.SelectedValue);
                    sqlCmd.ExecuteNonQuery();
                    MessageBox.Show("Запись успешно изменена");
                    LoadAuth();
                }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("publishers_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.Parameters.AddWithValue("@id", comboBox5.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@name", textBox9.Text);
                    sqlCmd.Parameters.AddWithValue("@year", textBox8.Text);
                    sqlCmd.Parameters.AddWithValue("@director", textBox10.Text);
                    sqlCmd.Parameters.AddWithValue("@country", comboBox9.SelectedValue);
                    sqlCmd.ExecuteNonQuery();
                    MessageBox.Show("Запись успешно изменена");
                    LoadPublish();
                }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("publications_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.Parameters.AddWithValue("@id", comboBox6.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@name", textBox12.Text);
                    sqlCmd.Parameters.AddWithValue("@publ_type", comboBox10.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@publ_year", textBox11.Text);
                    sqlCmd.Parameters.AddWithValue("@publisher", comboBox12.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@pages", textBox13.Text);
                    sqlCmd.Parameters.AddWithValue("@publ_language", comboBox11.SelectedValue);
                    sqlCmd.ExecuteNonQuery();
                    MessageBox.Show("Запись успешно изменена");
                    LoadPubl();
                }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                ...
                {
                    connection.Open();
                    var sqlCmd = new SqlCommand("publ_auth_update", connection);
                    sqlCmd.CommandType = CommandType.StoredProcedure;
                    sqlCmd.Parameters.AddWithValue("@id", comboBox7.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@author", comboBox13.SelectedValue);
                    sqlCmd.Parameters.AddWithValue("@publication", comboBox14.SelectedValue);
                    sqlCmd.ExecuteNonQuery();
                    MessageBox.Show("Запись успешно изменена");
                    LoadPublAuth();
                }
